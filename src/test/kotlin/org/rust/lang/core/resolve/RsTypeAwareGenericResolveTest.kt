...
import org.rust.lang.core.types.infer.TypeInferenceTestcrumbs
...
class RsTypeAwareGenericResolveTest : RsResolveTestBase() {
    ...
    fun `test no stack overflow with cyclic type of infinite size`() = TypeInferenceTestcrumbs.cyclicType.checkHit {
        checkByCode("""
            struct S<T>(T);
